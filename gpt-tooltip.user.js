(function () {
    'use strict';
    const OPENROUTER_API_KEY = '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'; // api key open routera opta
    const MODEL = 'openai/gpt-4o'; // lyba модель
    let tooltip;
    ...
    document.addEventListener('mouseup', async (e) => {
        ...
        try {
            ...
            const answer = data?.choices?.[0]?.message?.content || "pishow";
